		...
		<main className="container mx-auto px-1 py-2 flex-grow">
			...
			<div className="max-w-4xl mx-auto p-4">
				...
				<div className="space-y-6">
					...
					<p className="text-[17px] leading-relaxed text-[#333333]">
						Os aprovados receberão formação técnica e passarão a atuar diretamente em escolas públicas próximas de suas residências, fortalecendo o vínculo com a comunidade escolar e promovendo a integração entre a escola, os alunos e as famílias. As atribuições incluem auxílio na organização das salas e espaços escolares, apoio na entrada e saída dos alunos, colaboração em atividades educativas e recreativas, além de apoio no atendimento às famílias e à comunidade escolar.
					</p>
					...
					<div className="mt-8 border border-gray-200 overflow-hidden">
						...
						<div className="p-6">
							<ul className="space-y-3 list-disc pl-4">
								...
								<li>
									<span className="text-[#1351B4] font-semibold">88%</span> dos estudantes diplomadas(os) até julho de <span className="text-[#1351B4]">2026</span>
								</li>
							</ul>
						</div>
					</div>
