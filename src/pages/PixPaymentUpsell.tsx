      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div className="bg-blue-5 p-2 rounded-lg mb-4">
          <p className="text-sm text-blue-700">
            Para acessar o curso em vídeo, escaneie o QR Code ou copie o código PIX abaixo
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
          <p className="text-sm text-yellow-800">
            <strong>AVISO:</strong> O acesso ao curso será liberado imediatamente após a confirmação do pagamento.
          </p>
        </div>
...
export default PixPaymentUpsell;